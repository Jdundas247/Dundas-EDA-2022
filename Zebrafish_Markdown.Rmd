...
> Because maximum velocity is paired with the overall score of different body parts (low score means less developed therefore lower Vmax) the data suggests that early hatching via alarm cue does impact development in some way. Maximum velocities were shown to be different meaning that at least some parts of the bodies development was impacted.
