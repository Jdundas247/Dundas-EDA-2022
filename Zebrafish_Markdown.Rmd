...
```
>T test shows a significant difference in hatch time between cue types. (t= 5.21, df=74, p <0.05) Stat tests were done using R-Studio. 
...
>T test shows a significant difference in maximum velocity between cue types (t= 2.13, df=74, p <0.05) Stat tests were done using R-Studio. 
